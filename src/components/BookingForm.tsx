...
import { MapPin, Clock, Calendar, Car, Check, ArrowRight, ArrowLeft } from "lucide-react";
...
const BookingForm = () => {
  ...
  const handleConfirm = () => {
    toast({
      ...
      description: "Your booking is pending confirmation. We'll notify you shortly.",
    });
    setStep(1);
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm font-semibold text-accent mt-1">
                      {bookingType === "hourly"
                        ? `R${vehicle.pricePerHour * formData.hours} (${formData.hours}hrs)`
        ...
        {step === 3 && (
          ...
          >
            ...
            <div className="flex gap-3">
              ...
              <Button variant="hero" size="lg" className="flex-1" onClick={handleConfirm}>
                Confirm Booking
              </Button>
            </div>
          </motion.div>
